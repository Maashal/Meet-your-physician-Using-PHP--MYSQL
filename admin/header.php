    ...
    <div class="main-container">
        <nav class="navbar navbar-fixed-top admin-navbar">
            <div class="container-fluid" style="background:white !important;">
				...
				<h3 > Admin Panel  </h3><h2><a href="add_employee.php">
            <span class="remove_text">Create New Employee Profile</span></a> 
            <a href="manage_employee.php">
            <span class="remove_text">View Employee Profile</span></a>
            <a href="update_employee.php">
            <span class="remove_text">Update Employee Profile</span></a>
            <a href="delete_employee.php">
            <span class="remove_text">Delete Employee Profile</span></a>
        <a href="logout.php">
